(function() {
    ...
    const ws = new WebSocket('wss://media.agent4.ai/chat/ZmUyNjljNTQtNzlkNS0xMWVlLWE3YTgtMGE1OGE5ZmVhYzAy');
    //const ws = new WebSocket('wss://centipede.ngrok.app/chat/ZmUyNjljNTQtNzlkNS0xMWVlLWE3YTgtMGE1OGE5ZmVhYzAy/');
    ...
    ws.onmessage = function(event) {
        ...
        if (receivedData.message) {
            chatOutput.innerHTML += `<p><strong>Friday:</strong> ${receivedData.message}</p>`;
